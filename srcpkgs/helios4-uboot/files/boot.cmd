#
# Please edit /boot/uboot-env.txt to set supported parameters
#
# Based on Armbian's /boot/boot.scr
...
# if the prefix variable wasn't defined by the caller define it now
if test -n ${prefix}; then
	setenv prefix "/boot/"
fi

if load ${devtype} ${devnum} ${load_addr} ${prefix}uboot-env.txt; then
	env import -t ${load_addr} ${filesize}
fi

setenv bootargs "console=ttyS0,115200 root=${rootdev} rootwait rootfstype=${rootfstype} ubootdev=${devtype} scandelay loglevel=${verbosity} ${extraargs}"
